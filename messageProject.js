let arrayOfFortune = ["A faithful friend is a strong defense.",
...
function fourtuneTeller(){
    console.log(arrayOfFortune[Math.floor(Math.random() * arrayOfFortune.length)]);
}
fourtuneTeller();